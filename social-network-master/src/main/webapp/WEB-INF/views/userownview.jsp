...
<div class='row'>
    <div class='column'>
        <h2 class='center'>Received Money</h2>
        <table class='center'>
            <tr>
                <th>Created</th>
                <th>User</th>
    ...
    <div class='centralcolumn'>
        <div class='center'>
            ...
            <form:form method='POST' modelAttribute='user'>
                ...
                <form:input path='password' type='password' placeholder='your password' /><br><br>
            ...
            <br>
            <h1 class='center'>Your Expenses</h1>
            <table class='center'>
                <tr>
                    <th>Created</th>
                    <th>Text</th>

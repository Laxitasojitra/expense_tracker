...
<h3 class='center'>View Expenses</h3>
<br>
<br>
<div class='center'>
    <table class='center'>
...
<h3 class='center'>Expenses : ${fn:length(allComments)}</h3>
<div class='center'>
    <table class='center'>
        <tr>
            <th>Created</th>
    ...
    <form:form method='POST' modelAttribute='comment' action='comment'>
        <form:textarea path='text' cols='31' rows='2' maxlength='60' placeholder='Enter Your Expense Part...'></form:textarea><br>
